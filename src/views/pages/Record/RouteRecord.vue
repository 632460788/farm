...
<div class="container" id="container" style="position:relative; height:100%;width: 100%;background-color: white;scroll-behavior: auto;overflow-y: auto;" >
<!--      <span style="font-size: 20px;color: black;fontFamily:'Microsoft yahei';">地块编号:  </span>-->
<!--      <el-select v-model="LotID" placeholder="选择地块编号"  >-->
<!--        <el-option v-for="item in getLotList(lotPathList)" :key="item.lotID" :label="item.lotName"-->
<!--                   :value="item.lotID" ></el-option>-->
<!--      </el-select>-->
<!--      <kt-button icon="fa fa-search" label="查找" type="primary" />-->
  ...
  <div id="box1" class="pie" style="display: inline-block;width: 13%;"></div>
  <div id="box2" class="pie" style="display: inline-block;width: 13%"></div>
  <div id="box3" class="pie" style="display: inline-block;width: 13%"></div>
  <div id="box4" class="pie" style="display: inline-block;width: 13%"></div>
  <div id="box5" class="pie" style="display: inline-block;width: 13%"></div>
  <div id="box6" class="pie" style="display: inline-block;width: 13%"></div>
  <div id="box7" class="pie" style="display: inline-block;width: 13%;"></div>


  <el-row style="position:relative;width: 100%;height: 33%" :gutter="40">

    <el-col :span="6" style="width: 25%;height: 100%;margin: 0 auto">
  ...
  <el-row style="position:relative;width: 100%;height: 33%" :gutter="40">
    ...
    <el-col :span="6" style="width: 25%;height: 100%">
      <div id="elementBar7" style="width: 100%;height: 95%"></div>
      <div style="position: relative;top: -5%">
        <span style="font-size: 10px;color: black;font-Family:'Microsoft yahei'">元素名称:  </span>
        <el-select v-model="elementId[6]"  size="mini" style="position:relative;width: 25%;" @change="elementChange('elementBar7',elementId[6])">
          <el-option v-for="(item,index) in legendTempList" :key="index" :label="item"
                     :value="index" ></el-option>
        </el-select>
      </div>
    ...
    <el-col :span="6" style="width: 25%;height: 100%">
      <div id="elementBar8" style="width: 100%;height: 95%"></div>
      <div style="position: relative;top: -5%">
        <span style="font-size: 10px;color: black;font-Family:'Microsoft yahei'">元素名称:  </span>
        <el-select v-model="elementId[7]"  size="mini" style="position:relative;width: 25%;" @change="elementChange('elementBar8',elementId[7])">
          <el-option v-for="(item,index) in legendTempList" :key="index" :label="item"
                     :value="index" ></el-option>
        </el-select>
      </div>
