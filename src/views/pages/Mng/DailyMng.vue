<template>
  <div class="page-container">
    ...
    <!--新增编辑界面-->
    <!--     TODO 可优化新增编辑界面-->
    <el-dialog :title="operation?'新增日常作业记录':'编   辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
               label-position="right">
        <el-form-item label="ID" prop="id" v-if="!operation">
          <el-input v-model="dataForm.id" :disabled="true" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="作业类别" prop="jobs">
          <el-select v-model="dataForm.jobs" :placeholder="dataForm.jobs" style="width: 100%;">
    ...
    export default {
      ...
      data() {
        return {
          ...
          dataFormRules: {
            ...
            jobs: [
              {required: true, message: '请输设置作业类别', trigger: 'blur'}
            ],
            time: [
              {required: true, message: '请输设置作业时间', trigger: 'blur'}
            ]
          },
          queryFormRules: {
            start: [
      ...
      methods: {
        ...
        findPageByDate: function(){
          ...
          console.log(this.filters.LotID)


          //注意，当时间选择框取消掉之后，值变为null，初始值为 ''，所以要同时判断
          ...
          //if ( (this.isNULL(this.filters.start) && this.isNULL(this.filters.end) && this.filters.LotID === '') || (this.filters.start === '' && this.filters.end === '' && this.filters.LotID === '')){
          //  console.log("NULL / find All")
          //  this.$message({message: '请设置查询条件 ', type: 'error'})
          //}
          else{
            ...
            this.$api.dailyjobs.findPageByDate(params).then((res) => {
        ...
        handleDelete: function (data) {
          ...
          console.log(param)
          try{
            this.$api.dailyjobs.batchDelete(param).then(data !== null ? data.callback : '')
          }
          catch (e) {
          ...
          this.$refs.dataForm.validate((valid) => {
            if (valid) {
              this.$confirm('确认提交吗？', '提示', {}).then(() => {
                ...
                this.$api.dailyjobs.save(params).then((res) => {
        ...
        initColumns: function () {
          this.columns = [
            ...
            {prop: "jobs", label: "作业类型", minWidth: 120},
